  ...
  <div class="container">
    <div class="row justify-content-center vh-100">
      <div class="col-xl-4 col-lg-5 col-sm-6 col-12 m-auto">
        <form action="{{ route('cek-register') }}" method="post" class="my-5">
          @csrf
          <div class="border rounded-2 p-4 mt-5">
            <div class="login-form">
              ...
              <div class="mb-3">
                ...
                <input type="text" id="nama" name="nama" class="form-control @error('nama') is-invalid @endError" placeholder="Budi" value="{{ old('nama') }}"/>
                @error('nama')
                <div class="alert alert danger p-0 m-0">
                  {{ $message }}
                </div>
              ...
              <div class="text-center">
                ...
                <a href="{{ url('login') }}" class="text-blue text-decoration-underline ms-2"> Log In</a>
              </div>
            </div>
          </div>
        </form>
